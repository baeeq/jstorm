...
public class TopologyPage implements Serializable {
    ...
    private List<Components> getComponents(
        ...
        for (Entry<String, List<TaskSummary>> entry : componentMap.entrySet()) {
            ...
            Components component = UIUtils.getComponent(taskList, componentId, type,
                    window);
    ...
    public static void main(String[] args) {
        ...
        try {
            TopologyPage instance = new TopologyPage("sequence_test-1-1363056062",
                    StatBuckets.ALL_WINDOW_STR);
        } catch (Exception e) {
