 ...
 * object
 * for O(1) time, meaning the object is essentially always available for
 * poll/offer
 */
public class TimeCacheQueue<K>{
    ...
    public static class DefaultExpiredCallback<K> implements ExpiredCallback<K> {
        protected static final Logger LOG = Logger.getLogger(TimeCacheQueue.DefaultExpiredCallback.class);
