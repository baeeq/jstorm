          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.num_executors = new HashMap<String,Integer>(2*_map210.size);
              for (int _i211 = 0; _i211 < _map210.size; ++_i211)
              {
                String _key212; // required
                int _val213; // required
                _key212 = iprot.readString();
                _val213 = iprot.readI32();
                this.num_executors.put(_key212, _val213);
              }
              iprot.readMapEnd();
            }
          } else { 
    ...
    if (this.num_executors != null) {
      if (is_set_num_executors()) {
        oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter214 : this.num_executors.entrySet())
          {
