...
public class WorkerSummary implements org.apache.thrift.TBase<WorkerSummary, WorkerSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField TOPOLOGY_FIELD_DESC = new org.apache.thrift.protocol.TField("topology", org.apache.thrift.protocol.TType.STRING, (short)2);
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.tasks = new ArrayList<TaskSummary>(_list202.size);
              for (int _i203 = 0; _i203 < _list202.size; ++_i203)
              {
                TaskSummary _elem204; // required
                _elem204 = new TaskSummary();
                _elem204.read(iprot);
                this.tasks.add(_elem204);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.tasks != null) {
      oprot.writeFieldBegin(TASKS_FIELD_DESC);
      {
        ...
        for (TaskSummary _iter205 : this.tasks)
        {
