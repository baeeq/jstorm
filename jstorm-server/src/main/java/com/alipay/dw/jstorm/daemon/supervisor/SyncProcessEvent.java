...
import com.alipay.dw.jstorm.daemon.worker.Worker;
...
class SyncProcessEvent extends ShutdownWork {
    ...
    private MQContext                         sharedContext;
     ...
     */
    @Deprecated
    public void launchWorker(Map conf, MQContext sharedcontext, String stormId,
...
//        return classpath;
     ...
     */
    public void launchWorker(Map conf, MQContext sharedcontext,
